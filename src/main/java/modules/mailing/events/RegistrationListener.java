...
public class RegistrationListener implements Listener {
    ...
    public void invokeListener(EventType eventType, String message){
        ...
        String messageBody = buildVerifyRegistrationEmailBody(otpDTO.getOtp(), otpDTO.getTo());
    ...
    private String buildVerifyRegistrationEmailBody(String otpCode, String recipientEmail){
        return String.format(
                "<!DOCTYPE html>\n" +
                        ...
                        "                  <div style=\"font-size:13px; color:#9ca3af; margin-top:12px;\" class=\"dark-hint\">expires in <span style=\"font-weight:600; color:#4f46e5;\">10 minutes</span></div>\n" +
                        "                </td>\n" +
                        "              </tr>\n" +
                        "            </table>\n" +
                        "\n" +
